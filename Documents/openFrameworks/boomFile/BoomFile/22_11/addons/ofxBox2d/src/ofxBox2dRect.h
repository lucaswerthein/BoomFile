...
public:
	...
	//------------------------------------------------
	void setup(char * data,b2World * b2dworld, float x, float y, float w, float h, float myAngle, bool isFixed=false) {
		...
		b2BodyDef bodyDef;//new line of code
		...
		body->SetUserData(data); //new line of code
