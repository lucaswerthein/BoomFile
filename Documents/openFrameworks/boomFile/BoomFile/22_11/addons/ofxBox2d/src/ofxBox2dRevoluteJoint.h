...
public:
	...
	void addJoint(b2Body * a, b2Body * b, float stiffness=3.0f, float damping=0.6f, int Xoffset=0, int Yoffset=0, float motorSpeed =5.0) {
		...
		b2Vec2 anchor = b->GetWorldCenter();
		...
		//jd.localAnchor2.Set(anchor2->x,anchor2->y);
